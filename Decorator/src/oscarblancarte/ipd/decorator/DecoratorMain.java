...
import oscarblancarte.ipd.decorator.impl.decorators.MessageBDecorator;
import oscarblancarte.ipd.decorator.impl.decorators.MessageDecorator;
...
public class DecoratorMain {
    ...
    public static void main(String[] args) {
        ...
        IMessage message3 = new MessageBDecorator("Pronaca","Cdl. Calderon","0704266","pronaca@gmail.com", new SOAPEnvelopMessage(
                new EncryptMessage("user", "HG58YZ3CR9123456",
                        new XMLFormatterDecorate(customerMessage)))).processMessage();
