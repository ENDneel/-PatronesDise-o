...
public class Employee {
    ...
    public Employee(String name, int age, String gender, Address adress, List<Phone> phones, List<Contact> contacs,
	...
	public String toString() {
		return "Employee [name=" + name + ", age=" + age + ", gender=" + gender + ",  \nadress=" + adress + ",  \nphones="
				+ phones + ",  \ncontacs=" + contacs + ", department=" + department + "]";
	}
	...
	public static class EmployeeBuilder implements IBuilder<Employee>{
		...
		public EmployeeBuilder setDepartment(String mdepartment) {
			department= new Department(mdepartment);
			return this;
		}
