...
//        System.out.println("Date Format change > ");
	...
	public Locale getLocalConvert() {
		return localConvert;
	}

	public void setLocalConvert(Locale localConvert) {
		this.localConvert = localConvert;
		 notifyAllObservers("moneyConvert", this);
	}
